---
name: promptpropulser
description: >-
  Contextual cognition orchestration layer for LLMs.
  Attention Reinforcement Engine (ARE), Semantic Echo, Constraint Lock,
  Reflection Pipeline, LLM-as-Judge. Auto-detects mode from prompt intent.

triggers:
  - keywords: [codigo, API, implementa, funcion, bug, FastAPI, Python, endpoint]
    mode: code
    description: Programming — bugs, imports, edge cases, compatibility
  - keywords: [seguridad, vulnerabilidad, audita, exploit, hack, JWT, pentest]
    mode: brutal
    description: Hypercritical security audit with contradiction attack
  - keywords: [arquitectura, diseña, sistema, infraestructura, microservicios, escalable]
    mode: architect
    description: Complex system design, modular decomposition
  - keywords: [analiza, profundo, investiga, evalua, debug, reflection]
    mode: reflection
    description: Deep reasoning with self-critique and logic validation
  - keywords: [explicame, paso a paso, tutorial, ELI5, enseña, aprende]
    mode: teacher
    description: Progressive explanation with analogies
  - keywords: [rapido, breve, resumen, corto, TLDR, conciso, sintetiza]
    mode: compress
    description: Token minimization while preserving constraints
  - keywords: [NO uses, SIN usar, obligatorio, manten, no cambies, prohibido]
    mode: focus
    description: Aggressive constraint retention
---

# PromptPropulserClaude (PPC)
